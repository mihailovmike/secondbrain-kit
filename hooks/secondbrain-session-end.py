#!/usr/bin/env python3
"""Claude Code session-end hook: capture session knowledge into SecondBrain.

Extracts the last 30 conversation turns from the Claude Code transcript
and writes them to the vault inbox for engine processing.
"""
...
def main():
    ...
    note = f"""---
title: "Session: {project} ({date_str} {time_str})"
type: source
...
# Session: {project} ({date_str} {time_str})
